...
public class ClaimValidationLesson04Demo05Test extends AbstractRuleTest {

    @Autowired
    @Qualifier("claimValidationLesson04Demo05")
    ...
    public void validateClaim(){
        ...
        claimValidation.validateClaim(claimDto, null,"claim-validation");
    ...
    public void validateClaimWrongPolicy(){
        ...
        claimValidation.validateClaim(claimDto, policyDto,"claim-validation-wrong-policy");
        assertNotNull(claimDto.getStatus());
        assertNotNull(claimDto.getReason());
    ...
    public void validateClaimExceedCoverage(){
        ...
        claimValidation.validateClaim(claimDto, policyDto,"claim-validation-coverage");
        assertNotNull(claimDto.getStatus());
        assertNotNull(claimDto.getReason());
        assertEquals(Status.DENIED, claimDto.getStatus());
    ...
    public void validateClaimWithUnpaidPremium(){
        ...
        claimValidation.validateClaim(claimDto, policyDto,"claim-validation-unpaid-premiums");
        assertNotNull(claimDto.getStatus());
        assertNotNull(claimDto.getReason());
        assertEquals(Status.DENIED, claimDto.getStatus());
