...
@Component("claimValidationLesson04Demo05")
public class ClaimValidationLesson04Demo05 extends AbstractValidateApplication implements ClaimValidation {


    @Autowired
    public ClaimValidationLesson04Demo05(@Qualifier("kieContainerLesson04demo05") KieContainer kieContainer) {
        super(kieContainer);
    }
