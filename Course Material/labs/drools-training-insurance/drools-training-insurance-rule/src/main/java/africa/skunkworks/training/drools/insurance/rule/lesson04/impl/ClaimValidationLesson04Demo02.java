...
@Component("claimValidationLesson04Demo02")
public class ClaimValidationLesson04Demo02 extends AbstractValidateApplication implements ClaimValidation {

    @Autowired
    public ClaimValidationLesson04Demo02(@Qualifier("kieContainerLesson04demo02") KieContainer kieContainer) {
        super(kieContainer);
    }
