...
@Component("claimValidationLesson05Demo04")
public class ClaimValidationLesson05Demo04 extends AbstractValidateApplication implements ClaimValidation {

    @Autowired
    public ClaimValidationLesson05Demo04(@Qualifier("kieContainerLesson05demo04") KieContainer kieContainer) {
        super(kieContainer);
    }
