...
@Component("payoutLesson5Demo0202")
public class PayoutLesson5Demo0202 extends AbstractValidateApplication implements ClaimValidation {
    @Autowired
    public PayoutLesson5Demo0202(@Qualifier("kieContainerLesson05demo0202") KieContainer kieContainer) {
        super(kieContainer);
    }
