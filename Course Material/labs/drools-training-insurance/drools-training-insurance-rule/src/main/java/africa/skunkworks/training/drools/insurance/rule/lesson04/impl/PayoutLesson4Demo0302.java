...
@Component("payoutLesson4Demo0302")
public class PayoutLesson4Demo0302 extends AbstractValidateApplication implements ClaimValidation {
    @Autowired
    public PayoutLesson4Demo0302(@Qualifier("kieContainerLesson04demo0302") KieContainer kieContainer) {
        super(kieContainer);
    }
