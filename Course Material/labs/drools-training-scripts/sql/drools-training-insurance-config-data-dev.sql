...
VALUES ('spring.cloud.gateway.routes[0].id','drools-training-insurance','drools-training-gateway','dev','latest', 'latest','ENABLED'),
	  ('spring.cloud.gateway.routes[0].uri','lb://DROOLS-TRAINING-INSURANCE','drools-training-gateway','dev','latest', 'latest','ENABLED'),
      ('spring.cloud.gateway.routes[0].predicates[0]','Path=/drools/training/insurance/**','drools-training-gateway','dev','latest', 'latest','ENABLED'),
      ...
      ('spring.datasource.url','jdbc:postgresql://quankee-postgres:5432/quankee?','drools-training-insurance','dev','latest', 'latest','ENABLED'),
