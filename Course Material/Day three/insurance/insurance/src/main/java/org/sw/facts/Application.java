...
public class Application {
    ...
    public boolean isOverweight() { return BMI >= 25 && BMI <= 29; }

    public boolean isObeseA() { return BMI >= 30 && BMI <= 34; }

    public boolean isObeseB() { return BMI >= 35 && BMI <= 39; }

    public boolean isObeseC() { return BMI >= 40; }
    ...
    // Setters
    public void addPremium(int amount) { this.premium += amount; }
